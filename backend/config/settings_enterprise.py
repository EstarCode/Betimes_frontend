...
Production-ready configuration for Betimes Enterprise Platform
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='betimes_enterprise'),
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'RS256',
    'SIGNING_KEY': config('JWT_PRIVATE_KEY', default=None),
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@betimes.com')
...
ENTERPRISE_FEATURES = {
    ...
    'MAX_BATCH_UPLOADS': 50,
    'MAX_DOCUMENT_VERSIONS': 50,
    'MAX_WORKFLOW_STAGES': 10,
    'WORKFLOW_ESCALATION_HOURS': 48,
